...
def build_parser():
    ...
    # Run Config
    parser.add_argument('-dataset', type=str, default='fmnist', choices=['mnist', 'fmnist', 'cifar10', 'cifar100'], help='Dataset')
    ...
    parser.add_argument('-train_model', type=str, default='vggnet', choices=['vggnet', 'resnet', 'densenet', 'pyramidnet'], help= 'Select train mode')
